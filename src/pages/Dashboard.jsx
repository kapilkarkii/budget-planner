    ...
    <div className={Styles.wrapper}>
      ...
      <div className={Styles.summaryRow}>
        <div className={`${Styles.summaryCard} ${Styles.balanceCard}`}>
          ...
          <p className={`${Styles.summaryValue} num`}><CountUp value={balance} /></p>
        </div>
        <div className={`${Styles.summaryCard} ${Styles.incomeCard}`}>
          ...
          <p className={`${Styles.summaryValue} num`}><CountUp value={income} /></p>
        </div>
        <div className={`${Styles.summaryCard} ${Styles.expenseCard}`}>
          ...
          <p className={`${Styles.summaryValue} num`}><CountUp value={expenses} /></p>
        </div>
      </div>
          ...
          <div className={Styles.card}>
            ...
            {recent.length === 0 ? (
              ...
              <ul className={Styles.txList}>
                {recent.map((t, i) => (
                  <li key={t.id} className={`${Styles.txRow} staggerItem`} style={{ animationDelay: `${i * 0.08}s` }}>
